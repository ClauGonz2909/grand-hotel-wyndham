      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaHotel className="text-4xl text-olive-grand mb-3" />
          ...
          {/* Beneficio 2 */}
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaConciergeBell className="text-4xl text-olive-grand mb-3" />
          ...
          {/* Beneficio 3 */}
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaUtensils className="text-4xl text-olive-grand mb-3" />
          ...
          {/* Beneficio 4 */}
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaMapMarkerAlt className="text-4xl text-olive-grand mb-3" />
          ...
          {/* Beneficio 5 */}
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaSpa className="text-4xl text-olive-grand mb-3" />
          ...
          {/* Beneficio 6 */}
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaMobileAlt className="text-4xl text-olive-grand mb-3" />
          ...
          {/* Beneficio 7 */}
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaCheckCircle className="text-4xl text-olive-grand mb-3" />
          ...
          {/* Beneficio 8 */}
          <div className="flex flex-col items-center text-center text-black-grand">
            <FaUsers className="text-4xl text-olive-grand mb-3" />
